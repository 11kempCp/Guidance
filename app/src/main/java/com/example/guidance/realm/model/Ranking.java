...
public class Ranking extends RealmObject {
    ...
    public Ranking(ObjectId _id, Integer steps, Integer location, Integer screentime, Integer socialness, Integer mood, Integer idealStepCount, Integer screentimeLimit) {
        this._id = _id;
        this.steps = steps;
