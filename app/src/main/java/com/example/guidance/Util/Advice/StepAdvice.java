...
public class StepAdvice {
     ...
     * @param days provides justification on the days where their step count has been high/low
     * @param steps provides justification on their step count over x amount of days
     * @param date a date in which the user is being advised to go for a walk on
     ...
     * @return stepAdvice
     */
    public static String getStepAdvice(int value, int days, float steps, Date date, String weather, Float temperature, Date sunrise, Date sunset) {
        String stepAdvice = null;
     ...
     * @return stepAdvice
     */
    public static String getStepAdvice(int value, int days, float steps, String name, Date date, String weather, Double temperature, Date sunrise, Date sunset) {
        String stepAdvice = null;
